...
/* 테이블 CSS 끝*/
.build.false, .rent.false, .move-in.false, .administrative.false,
	.parking.false, .pets.false, .elevator.false, .balcony.false, .built.false,
	.structure.false, .option.false, .chartered.false {
...
.build.false:hover, .rent.false:hover, .move-in.false:hover,
	.administrative.false:hover, .parking.false:hover, .pets.false:hover,
	.elevator.false:hover, .balcony.false:hover, .built.false:hover,
	.structure.false:hover, .option.false:hover, .chartered.false:hover {
	border: 1px solid #F27405;
}

.move-in.true, .administrative.true, .parking.true, .pets.true,
	.elevator.true, .balcony.true, .built.true, .structure.true, .option.true,
	.chartered.true {
	padding: 10px 25px 10px 25px;
	height: 50px;
	background-color: #FFFFFF;
...
<section class="contact-section">
	<div class="container2">
		<div class="row">
			<div class="col-md-12 mt-4 add-page">
				...
				<form id="estater" enctype="multipart/form-data">
					<div class="col-md-9 add-page" style="margin-left: 205px;">
						<!-- 매물종류 시작 -->
									...
									<td class="enrollBody">
										...
										<div class="jusoAPI">
											<input type="text" class="address-search" id="roadAddrPart1"
												...
												class="jusoSearch">주소검색</span><br> <input type="text"
												class="address-search" id="addrDetail" name="subaddr"
												placeholder="ex)강남구 역삼동"> <input type="text"
												id='zipNo' name="zipNo" name="zipNo"
								...
								<tr>
									...
									<td class="enrollrentBody">
										<div class="seleted-div col-md-12 dealvary">
											...
											<span class="square rent false" id='monthly'
												onclick="rent(2)">월세</span> <span class="square rent false"
												id='trading' onclick="rent(3)">매매</span> <span
												class="square deal rent false" onclick="deal()">단기가능</span>
										</div>
										<div class="col-md-12">
						...
						<div class="col-md-12 mt-12  add-sub-page">
							<table>
								...
								<tr>
									...
									<td class="enrollrentBody">
										<div class="col-md-12 ">
											<label class="add-page">건물층수</label> <select
												class="add-page floor" id="floor">
										...
										<hr>
										<div class="col-md-12 ">
											<label class="add-page">해당층수</label> <select
												class="add-page my-floor" id="myfloor">
												<option value="0">건물층수선택</option>
								...
								<tr>
									...
									<td class="enrollrentBody"
										style="padding-top: 10px; padding-bottom: 10px;" colspan="3">
										<div class="col-md-12 ">
									...
									<td colspan="3" class="enrollBody">
										<div class="indayCheck">
											<span class="square move-in false"
												...
												class="square move-in false" onclick="clicksub(1,'move-in')">날짜협의
											</span>
						...
						<div class="col-md-12 mt-12  add-sub-page" id="addinfo">
							<table>
								...
								<tr>
									...
									<td class="enrollrentBody">
										<div class="text-left">
											<span class="square parking false"
												onclick="clickpark(0,'parking')">가능</span> <span
												class="square parking false"
												onclick="clickpark(1,'parking')">불가능</span> <input
												type="text" id="parking" class="input-val"
												disabled="disabled" placeholder="0" value="0"
												style="margin-left: 5px;">&nbsp;원
										</div>
									</td>
						...
						<div class="col-md-12 mt-12 add-sub-page">
							<table>
								...
								<tr>
									...
									<td class="enrollrentBody" style="text-align: left;"><input
										type="text" style="width: 1221px; border: 1px solid #D8D8D8;"
										id="title" placeholder="예)신논현역 도보 5분거리,혼자살기 좋은방입니다."></td>
								</tr>
								<tr>
									<td class="enrollSideHeader">상세 설명</td>
									<td class="enrollrentBody"><textarea
											style="border: 1px solid #D8D8D8;" rows="20" cols="150"
											id="description"
											placeholder="
	            						상세설명 작성 주의사항 
						...
						<div class="col-md-12 mt-12 add-sub-page">
							<table>
								...
								<tr>
									...
									<td id="imageinputlist" class="enrollrentBody"><input
										type="file" name="mfile" value="" class="mfile"> <input
										type="button" onclick="inputFilePlus()" class="fileUpload"
										value="이미지 추가"></td>
								</tr>
							</table>
						</div>
						<div class="col-md-12 mt-12 last add-sub-page"
							style="padding-top: 0px; margin-bottom: 15px;">
							<div class="col-md-12">
								<div class="col-md-2" style="width: 100px;"></div>
								<div class="col-md-10"
									style="text-align: center; max-width: 100%;">
									<input type="checkbox" id="check"> 매물 관리 규정을 확인하였으며 입력한
									정보는 실제 매물과 다름이 없습니다.
								</div>
							</div>
							<div class="col-md-12" id="result"
								style="text-align: center; padding-top: 15px;">
								<input type='hidden' value='${user.anum}' name='anum'> <input
									type="hidden" value="" name="lat" id="lat"> <input
									type="hidden" value="" name="lng" id="lng"> <input
									type="hidden" value="" name="gu" id="gu"> <input
									type="hidden" value="" name="admindong" id="admindong">
								<a class="button3" id="filter_apply" onclick="submit()">매물등록</a>
								<a class="button4" id="filter_close"
									href="semi.Project?page=estate&code=1">취소</a>
							</div>
						</div>
					</div>
				</form>
		...
		<script>
			...
			var estateList = [ "administrative", "parking", "pets", "elevator",
					"balcony", "built", "option", "chartered", "structure" ]
			var storeList = [ "administrative", "parking", "elevator"
			...
			function addestate() {
				...
				if (build === '상가') {
					...
					input += "<input type='hidden' value='"
							+ $('#toilet').val() + "' name='toilet'>";
					input += "<input type='hidden' value='"
							+ $('#independent').val() + "' name='independent'>";
					input += "<input type='hidden' value='"
							+ $('#cooling').val() + "' name='cooling'>";
					input += "<input type='hidden' value='"
							+ $('#usearea').val() + "' name='usearea'>";
					input += "<input type='hidden' value='"
							+ $('#mpurpo').val() + "' name='mpurpo'>";
				} else {
			...
			function deal() {
				if ($('.deal').hasClass('false')) {
					$('.deal').css('color', 'white').css('background-color',
							'#FD7400');
					$(this).removeClass('false').addClass('true');

				} else if ($('.deal').hasClass('true')) {
					$('.deal').css('color', 'black').css('background-color',
							'white');
				...
				if (num === 1) {
					if (nnum === 0) {
						...
						html = "<label class='lnum-"+lnum+"'>"
								...
								+ "<span>만원</span>"
								+ "<p class='dealdescription'>(예 전세 2000만원)</p></label>";
						nnum++;
						text = '전세';
					} else {
						return;
					...
					html = "<label class='lnum-"+lnum+"'>"
							...
							+ "<span>만원</span>"
							+ "<p class='dealdescription'>(예 월세 1000만원/50만원)</p></label>";
					mnum++;
					text = '월세';
				}
